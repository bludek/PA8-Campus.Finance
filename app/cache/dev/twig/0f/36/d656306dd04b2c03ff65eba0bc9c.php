...
class __TwigTemplate_0f36d656306dd04b2c03ff65eba0bc9c extends Twig_Template
{
    protected $parent;
        ...
        if ($this->getAttribute($this->getContext($context, 'collector'), "logs", array(), "any", false)) {
            ...
            foreach ($context['_seq'] as $context['_key'] => $context['log']) {
                ...
                echo "
                    ";
                // line 35
                if (($this->getAttribute($this->getContext($context, 'log'), "context", array(), "any", true) && (!twig_test_empty($this->getAttribute($this->getContext($context, 'log'), "context", array(), "any", false))))) {
                    // line 36
                    echo "                        <br />
                        <small>
